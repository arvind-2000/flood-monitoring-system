              ...
              CardsContainer(
                ...
                childs: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Theme.of(context).colorScheme.secondary.withOpacity(0.2),Theme.of(context).colorScheme.primary.withOpacity(0.3)],
                  ...
                  child: Column(
                    ...
                    children: [
                      Text('Prediction',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
                      Text('Next $checktime mins',style: TextStyle(color: Theme.of(context).colorScheme.surface.withOpacity(0.5)  ),),
                      SizedBox(height: 10,),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: riverprovider.getPredictions.map((e) => Column(
                          children: [
                            Text(e.name,style: TextStyle(fontWeight: FontWeight.bold)),
                            Text(e.usv,style: TextStyle(fontWeight: FontWeight.bold)),
                          ],
                        )).toList(),
                      ),
                    ],
