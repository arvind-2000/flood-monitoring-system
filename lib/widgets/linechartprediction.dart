...
class LineChartsPredWidget extends StatefulWidget {
    LineChartsPredWidget({
    super.key,
  ...
  final bool isLine;
  @override
  State<LineChartsPredWidget> createState() => _LineChartsWidgetState();
}

class _LineChartsWidgetState extends State<LineChartsPredWidget> {
  int val = 20;
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      prov.predictionlist[0].river.isEmpty?const SizedBox(
         ...
         child: SfCartesianChart(
          ...
          primaryXAxis: NumericAxis(
             ...
             width: 0
                ...
                axisLabelFormatter:(axisLabelRenderArgs) => ChartAxisLabel( int.parse(axisLabelRenderArgs.text)==1?"Next":"Now",const TextStyle(fontSize:12)) ,
                  interval:1,
          ...
          series: prov.predictionlist.asMap().entries.map((e) =>widget.isLine? linecharts(e.value, e.key,Theme.of(context).colorScheme.secondary,prov) :barcharts(e.value, e.key,Theme.of(context).colorScheme.secondary,prov) ).toList(),
         ),
       ),
       Positioned(
            right: 0,
